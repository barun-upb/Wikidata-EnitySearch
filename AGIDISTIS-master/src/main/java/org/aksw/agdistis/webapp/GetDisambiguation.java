...
public class GetDisambiguation extends ServerResource {
	...
	public String standardAG(String text, NEDAlgo_HITS agdistis) throws IOException {
		...
		for (NamedEntityInText namedEntity : d.getNamedEntitiesInText()) {
			...
			// TODO: call getDescription method
			// obj.put("description", namedEntity.getDescription());
			arr.add(obj);
			TripleIndexContext context = new TripleIndexContext();
			String findStr = "germany";
			List<Triple> list = context.search(null, findStr, null);
			int D = list.size();// no. of document
			System.out.println(D);
			String file = "";
			int i = 0, avls = 0, ls = 0, totalLength = 0;
	...
	public static void main(String[] args) throws IOException {
		...
		GetDisambiguation getDisambiguation = new GetDisambiguation();
		getDisambiguation.standardAG(payload, null);
	}
}
